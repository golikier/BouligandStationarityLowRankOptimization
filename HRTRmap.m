function [L, R, g_new, NormGrad, lambda] = HRTRmap(L, R, f0, f1, f2, gamma, gamma_c, eta)
%% Description
% Author: Guillaume Olikier (2025-06-13)
% This function implements the iteration map of HRTR [LKB23, Algorithm 1]
% with the first lift phi of [LKB23, (1.1)], namely phi(L, R) := L*R', the
% hook from [LKB23, Example 3.11], and the Cauchy step.
% Input:
...
% Output:
%   - the matrices L and R generated by the HRTR map;
%   - the value g_new of f0 at L*R';
%   - NormGrad, the norm of the gradient before applying the HRTR map;
%   - lambda, the smallest eigenvalue of the Hessian before applying the HRTR map.
