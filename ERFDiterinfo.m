...
tic
for i = 2:iter
    [s{i}, U{i}, V{i}, f(i)] = ERFDmap(m, n, r, length(s{i-1}), s{i-1}, U{i-1}, V{i-1}, g0, g1, a, b, c, subclass);
    time(i) = toc;
end
end